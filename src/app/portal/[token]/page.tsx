            ...
            <div className="flex flex-col gap-5">
              ...
              {centineliReviewUrl && (
                <a
                  ...
                  style={{ background: 'var(--c-surface)', border: '1px solid var(--c-border-2)', backdropFilter: 'blur(12px)', WebkitBackdropFilter: 'blur(12px)', textDecoration: 'none' }}
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-semibold" style={{ color: 'var(--c-text)' }}>¿Cómo te está yendo con Centinelia?</p>
                    <p className="text-xs mt-0.5" style={{ color: 'var(--c-text-3)' }}>Comparte tu experiencia en Google — nos ayuda mucho</p>
                  </div>
                  <ExternalLink size={14} style={{ color: 'var(--c-text-3)', flexShrink: 0 }} />
                </a>
              )}
            </div>
          )}
