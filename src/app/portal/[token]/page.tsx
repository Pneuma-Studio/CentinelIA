  ...
  return (
    <ThemeProvider storageKey="centinelia-portal-theme" defaultTheme="dark">
      <div className="min-h-screen relative overflow-hidden" style={{ background: 'var(--c-bg)', color: 'var(--c-text)' }}>
        ...
        {/* Footer */}
        <div className="mt-2 px-4 sm:px-6 py-3 pb-20 sm:pb-4" style={{ borderTop: '1px solid var(--c-border)', position: 'relative', zIndex: 1 }}>
        ...
        {/* Review badge — fixed, centered between bottom edge and SupportChat button */}
        {centineliReviewUrl && (
          <a
          ...
          >
            ...
            ¿Qué tal funciona tu Centinelia?
          </a>
        )}
